        ...
        {phase === 'summary' && summary && (
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-3" style={{ paddingTop: 6 }}>
              ...
              <a
                href="https://sybilwildingwitchcraft.shop"
                target="_top"
                rel="noreferrer"
                className="inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium border border-amber-700/40 text-amber-200 hover:bg-amber-900/30 transition-colors"
              >
                Back to website
              </a>
            </div>
